...
PROJECT_DIR='/home/nour/AppFetch/amdroid' #$1 #read -p "Please Enter Path of the project:" PROJECT_DIR
...
adb shell am start -n "com.core.lambdaapp/MainActivity" -a android.intent.action.MAIN -c android.intent.category.LAUNCHER
